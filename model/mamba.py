    ...
    def __init__(
        ...
        **kwargs,
        ...
        if patch == 8:
            ...
            scan_file = 'index/128_ZScan_spiral.npy'
            scan_r_file = 'index/128_ZScanR_spiral.npy'
        elif patch == 256: 
            scan_file = 'index/256_ZScan_spiral.npy'
            scan_r_file = 'index/256_ZScanR_spiral.npy'
